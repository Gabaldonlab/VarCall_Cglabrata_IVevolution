...
# This file is for running trimmomatic, and it has to be run with Cglabrata_InVitroEvol_env. It will not repeat anything unless stated
...
JAVA = "%s/anaconda3/envs/VarCall_CNV_env/bin/java"%ParentDir
TRIMMOMATIC = "%s/software/Trimmomatic-0.38/trimmomatic-0.38.jar"%ParentDir 
